...
stations %>% walk(plot_ctdprofile_station, data = dat, 
                  variable = "NO3+NO2-N", points = TRUE)
...
stations %>% walk(plot_ctdprofile_station, data = dat, 
                  variable = "TOTN (old EF)", points = TRUE)
